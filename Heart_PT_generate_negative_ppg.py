...
model_path = r"C:\Users\ailab\PycharmProjects\ppg2\PPGPT_500k_iters\PPGPT_500k_iters.pth"

input_csv_path = r"C:\Users\ailab\PycharmProjects\ppg2\train_test_negative_above_threshold_0.csv"
output_dir = r"C:\Users\ailab\PycharmProjects\ppg2"
...
augmented_df.to_csv(os.path.join(output_dir, "train_test_negative_augmented_0.csv"), index=False, header=False)
