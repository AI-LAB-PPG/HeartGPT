...
data_path = r"C:\Users\ailab\PycharmProjects\ppg2\processed_data_X"
...
# 10 epoch 연속으로 개선되지 않으면 학습을 자동으로 중단
...
# 검증 정확도가 향상될 때마다 파일로 모델 저장
model_checkpoint = ModelCheckpoint(
    filepath=os.path.join(data_path, 'best_emotion_model.keras'),
